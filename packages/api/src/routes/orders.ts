...
const sendSchema = z.object({
  ...
  parcel_description: z.string().optional(),
  declared_value: z.number().int().nonnegative().optional(),
...
const receiveSchema = z.object({
  ...
  user_id_proof_url: z.string().url().optional(),
  user_signature_url: z.string().url().optional(),
  scheduled_pickup_at: z.string().datetime().optional(),
});
